...
var newD = data.map(function(record) {
    ...
    var nu = sex == "M" ? "na" : "ney";
    var remember = sex == "M" ? "endatresa" : "endatreshi";
    ...
    var messege = `Hi ${nickname} endet ${greet}? zare ye Team program mihonew Bethel Mekane Eyesyus nw. Ena adis bota slehone 11:15 sihon Shell tegenagnten abren enhedalen. Begize enegenagn. ${bless}!`;
