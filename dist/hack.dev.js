...
var newD = data.map(function (record) {
  ...
  name = name.toUpperCase(); // console.log(record);
  ...
  var marfed = sex == "M" ? "arefedk" : "arefedsh"; // var messege = `Hi, ${name} endet ${greet}? Nege ke fellow buhala retreat slemengeba mekret aychalem. in case maymechachu kalachum asaweku. Ena le retreat yemihon ke 50 birr jemro eske zare mata le leaders endetsetu yhun. `;
  ...
  var messege = "Hi ".concat(nickname, " endet ").concat(greet, "? as we all know zare hack engebalen. So, mata ke fellow bohala abren enhedalen. bring your PC and ansola . See you all! Horeb Leaders"); //console.log(messege,messege.length);

  sendIt(name, phone, messege); // console.log(messege.length)
