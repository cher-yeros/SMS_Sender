...
var newD = data.map(function (record) {
  ...
  var marfed = sex == "M" ? "arefedk" : "arefedsh"; //var messege =  `Hi ${name}, endet ${greet} nege Horeb team Skill devt slalen, 03:00 lay MKC enegenagn. see you tommorow!`
  ...
  var messege = "Hi ".concat(nickname, " endet ").concat(greet, "? ene dena negn. Zare 11:30 team endalen ").concat(last, " nw. begize enegenagn. ").concat(bless, " !");
  console.log(messege, messege.length, ++i);
  sendIt(name, phone, messege); //console.log(nickname)
});
